<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Departments.aspx.cs" Inherits="FixedAssets.Admin.Admin" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <button type="button" class="btn btn-primary m-3">
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Admin/EditDepartments.aspx">Editar Departamento</asp:HyperLink>
        </button>

        <button type="button" class="btn btn-danger m-3">
            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Admin/DeleteDepartments.aspx">Eliminar Departamento</asp:HyperLink>
        </button>
                    ...
                    style="color: black">
                        ...
                        <div class="modal-content">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <label for="TextBoxId" class="sr-only">ID Departamento</label>
                                <asp:TextBox
